...
public abstract class Monstre {
	...
	public abstract void chercherChemin(Position destination);//algo de pathfinding appelé a chaque ajout ou destruction de tour, remplissant la liste chemin vers un joueur ou une tour
	
	public void avancer(){
		//Méthode appelée lors du tick du timer pour faire avancer le monstre d'une case
	...
	public abstract void attaquer(Position cible);//Permet d'attaquer la cible(joueur ou tour) donnée en parametre
	*/
}
